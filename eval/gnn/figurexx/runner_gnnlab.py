import os, sys, copy
sys.path.append(os.getcwd()+'/../common_gnnlab')
...
cfg_list_collector.concat(cur_common_base.copy().override('dataset', [Dataset.friendster,       ]).override('cache_percent', [0.14]).override('num_feat_dim_hack', [256])) # should be 0.16
...
cfg_list_collector.hyper_override(
  ...
  [
    ...
    # [CachePolicy.coll_cache_asymm_link_2, "", "MPSForLandC"],
  ])
