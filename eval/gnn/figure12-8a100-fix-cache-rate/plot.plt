...
plot cmd_filter_dat_by_policy(dat_file, "sage_sup", "^GNN"     ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_C lc rgb "#af2318" t "GNNLab", \
     cmd_filter_dat_by_policy(dat_file, "sage_sup", "^WG"      ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_C lc rgb "#f19e38" t "WholeGraph", \
     cmd_filter_dat_by_policy(dat_file, "sage_sup", "^Coll*"   ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_C lc rgb "#0080ff" t "UGache", \
...
set arrow from  graph 0.2, graph -0.17 to graph 0.8, graph -0.17 nohead lt 1 lw 2 lc "#000000" front
plot cmd_filter_dat_by_policy(dat_file, "sage_unsup", "^GNN"   ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_C lc rgb "#af2318" t "GNNLab", \
     cmd_filter_dat_by_policy(dat_file, "sage_unsup", "^WG"    ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_C lc rgb "#f19e38" t "WholeGraph", \
     cmd_filter_dat_by_policy(dat_file, "sage_unsup", "^Coll*" ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_C lc rgb "#0080ff" t "UGache", \
