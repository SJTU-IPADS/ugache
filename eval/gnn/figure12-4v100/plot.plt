...
eval(handle_multiplot_location(0,0))
set yrange [0:3.5]
plot cmd_filter_dat_by_policy(dat_file, "sage_sup", "^GNN"    ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_A lc rgb "#af2318" t "GNNLab", \
     cmd_filter_dat_by_policy(dat_file, "sage_sup", "^Cliq"   ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_A lc rgb "#f19e38" t "WholeGraph", \
     cmd_filter_dat_by_policy(dat_file, "sage_sup", "^Coll*"  ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_A lc rgb "#0080ff" t "UGache"
...
set yrange [0:3.5]
plot cmd_filter_dat_by_policy(dat_file, "sage_sup", "^GNN"    ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_A lc rgb "#af2318" t "GNNLab", \
     cmd_filter_dat_by_policy(dat_file, "sage_sup", "^Cliq"   ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs transparent pattern 6 lc rgb "#000000" t "+CPU", \
     cmd_filter_dat_by_policy(dat_file, "sage_sup", "^Coll*"  ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_A lc rgb "#0080ff" t "UGache"
...
plot cmd_filter_dat_by_policy(dat_file, "sage_unsup", "^GNN"  ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_A lc rgb "#af2318" t "", \
     cmd_filter_dat_by_policy(dat_file, "sage_unsup", "^Cliq" ) using (column(col_epoch_total)):xticlabels(col_dataset) w histogram fs pattern fs_pattern_A lc rgb "#f19e38" t "", \
